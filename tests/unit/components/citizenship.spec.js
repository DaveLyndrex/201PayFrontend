...
import citizenship from "../../../src/views/human-resources/setups/Citizenship.vue";
...
describe("Component", () => {
    ...
    it("input config", () => {
        expect(JSON.stringify(getMountedComponent(citizenship, {}).vm.inputConfig)).toBe(
            JSON.stringify([{
    ...
    it("contains name and assignment", () => {
        expect(getMountedComponent(citizenship).vm.headers).toEqual([
            { text: "Legistation Code", value: "LegislationCode" },
            { text: "Citizenship Status", value: "CitizenshipStatus" },
    ...
    it("should find and trigger button cancel", async() => {
        const wrapper = getMountedComponent(citizenship, {});
...
describe("test citizenship method", () => {
    ...
    beforeEach(() => {
        ...
        wrapper = shallowMount(citizenship, { user_session, user_details, localVue });
    })
