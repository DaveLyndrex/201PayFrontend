...
import visa from "../../../src/views/human-resources/setups/VisaSetup.vue";
...
describe("VisaSetup.vue", () => {
    ...
    it("input config", () => {
        expect(JSON.stringify(getMountedComponent(visa, {}).vm.inputConfig)).toBe(
            JSON.stringify([{
    ...
    it("contains name and assignment", () => {
        expect(getMountedComponent(visa).vm.headers).toEqual([
    ...
    it("should find and trigger button cancel", async() => {
        const wrapper = getMountedComponent(visa, {});
...
describe("test visa method", () => {
    ...
    beforeEach(() => {
        ...
        wrapper = shallowMount(visa, { user_session, user_details, localVue });
    })
