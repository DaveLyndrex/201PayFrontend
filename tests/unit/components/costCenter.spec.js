...
import costCenter from "../../../src/views/human-resources/setups/CostCenter.vue";
...
describe("Component", () => {
    ...
    it("input config", () => {
        expect(JSON.stringify(getMountedComponent(costCenter, {}).vm.inputConfig)).toBe(
            JSON.stringify([{
                    inputLabel: "Cost Center Code",
                    inputType: "text",
                    inputModel: "CostCenterCode",
                    rules: [(v) => Validation.required(v, "Cost Center Code")],
                },
                {
                    inputLabel: "Cost Center Name",
                    inputType: "text",
                    inputModel: "CostCenterName",
                    rules: [(v) => Validation.required(v, "Cost Center Name")],
                },
            ])
        );
    });
    ...
    it("contains name and assignment", () => {
        expect(getMountedComponent(costCenter).vm.headers).toEqual([
            { text: "Cost Center Code", value: "CostCenterCode" },
            { text: "Cost Center Name", value: "CostCenterName" },
    ...
    it("should find and trigger button cancel", async() => {
        const wrapper = getMountedComponent(costCenter, {});
...
describe("test costCenter method", () => {
    ...
    beforeEach(() => {
        ...
        wrapper = shallowMount(costCenter, { user_session, user_details, localVue });
    })
