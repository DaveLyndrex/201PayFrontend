...
import project from "../../../src/views/human-resources/setups/Project.vue";
...
describe("Component", () => {
    ...
    it("input config", () => {
        expect(JSON.stringify(getMountedComponent(project, {}).vm.inputConfig)).toBe(
            JSON.stringify([{
                    inputLabel: "Project Code",
                    inputType: "text",
                    inputModel: "ProjectCode",
                    rules: [(v) => Validation.required(v, "Project Code")],
                },
                {
                    inputLabel: "Project Name",
                    inputType: "text",
                    inputModel: "ProjectName",
                    rules: [(v) => Validation.required(v, "Project Name")],
                },
            ])
        );
    });
    ...
    it("contains name and assignment", () => {
        expect(getMountedComponent(project).vm.headers).toEqual([
    ...
    it("should find and trigger button cancel", async() => {
        const wrapper = getMountedComponent(project, {});
...
describe("test project method", () => {
    ...
    beforeEach(() => {
        ...
        wrapper = shallowMount(project, { user_session, user_details, localVue });
    })
