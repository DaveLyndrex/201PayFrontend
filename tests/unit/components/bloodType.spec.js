...
import bloodType from "../../../src/views/human-resources/setups/BloodType.vue";
...
describe("BloodType.vue", () => {
    ...
    it("input config", () => {
        expect(JSON.stringify(getMountedComponent(bloodType, {}).vm.inputConfig)).toBe(
            JSON.stringify(
            [
                {
