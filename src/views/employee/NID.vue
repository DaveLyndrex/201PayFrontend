...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "National Identifier Type", value: "NationalIdentifierType" },
        {
          text: "National Identifier Number",
          value: "NationalIdentifierNumber",
        },
      ...
      inputConfig: [
        ...
        {
          inputLabel: "National Identifier Type",
          inputType: "text",
          inputModel: "NationalIdentifierType",
          rules: [(v) => Validation.required(v, "National Identifier Type")],
        },
        {
          inputLabel: "End Date",
          inputType: "date",
        ...
        {
          inputLabel: "National Identifier Number",
          inputType: "number",
          inputModel: "NationalIdentifierNumber",
          rules: [(v) => Validation.required(v, "National Identifier Number")],
        },
        {
  ...
  created() {
    ...
    EventBus.$on("saveItem", (props) => {
      if (this.editedIndex > -1) {
        Object.assign(this.nidData[this.editedIndex], props.item);
      } else {
        this.nidData.push(props.item);
      }
    });
  ...
  methods: {
    saveItem(data) {
      if (this.$refs.nidForm.validateForm()) {
    ...
    createNewItem: async function(data) {
      let create = await this.create(data, "createNIDData");
      this.nidData = this.$store.getters.allNIDData;
