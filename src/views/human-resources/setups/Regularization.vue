...
export default {
  ...
  methods: {
    ...
    retrieveData: async function () {
      ...
      try {
        let getdata = await this.retrieve(
          ...
          "setRegularizationSetup",
          "allRegularizationSetup"
        );
    ...
    createNewItem: async function (data) {
      ...
      let create = await this.create(data, "regularizationSetupAction");
      if (create) {
    ...
    deleteItem: async function (data) {
      this.savingChanges = true;
  try {
        let del = await this.$store.dispatch("deleteRegularizationPASetup", {
